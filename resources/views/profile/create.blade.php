...
　<h2 class="text-center">アカウント作成</h2>
    <form class="mt-4" action="{{ route('profile.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group d-flex justify-content-around">
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="inlineCheckbox1">洋楽ヒップホップ/R&B/レゲエ</label>
      </div>
      
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="music[]" id="music" value="洋楽ロック">
        <label class="form-check-label" for="inlineCheckbox2">洋楽ロック</label>
      </div>

      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="music[]" id="music" value="洋楽ダンス/エレクトロニカ">
        <label class="form-check-label" for="inlineCheckbox1">洋楽ダンス/エレクトロニカ</label>
      </div>
      
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="music[]" id="music" value="歌謡曲/演歌">
        <label class="form-check-label" for="inlineCheckbox2">歌謡曲/演歌</label>
      </div>

      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="music[]" id="music" value="ジャズ">
        <label class="form-check-label" for="inlineCheckbox1">ジャズ</label>
      </div>
      
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="music[]" id="music" value="クラシック">
        <label class="form-check-label" for="inlineCheckbox2">クラシック</label>
      </div>
...
<button type="submit" class="btn btn-primary btn-lg mt-6">上記の内容で登録する</button>
